...
from analyticabd.models import (
    LandingFAQ,
    LandingFeature,
    LandingPage,
    LandingStat,
...
class Command(BaseCommand):
    help = "Populate ABD Site with the current AI-company marketing content."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("ABD Site marketing content populated successfully."))
